...
│   │   ├── event-requests/ # Requirement capture and submission: Zod schema, form, page, draft writes
...
│   │   │   ├── event-requests.tsx # Capture and submit event requirements (organisers)
